                ...
                >
                    <div>
                        ...
                        <input name="name" type="text" value={form.name} onChange={handleChange} required placeholder="Your name"
                            className="w-full rounded-lg border px-4 py-3 text-gray-900 placeholder:text-gray-400"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input name="password" type="password" value={form.password} onChange={handleChange} required placeholder="At least 6 characters"
                            className="w-full rounded-lg border px-4 py-3 text-gray-900 placeholder:text-gray-400"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input name="confirmpassword" type="password" value={form.confirmpassword} onChange={handleChange} required placeholder="Confirm your password"
                           className="w-full rounded-lg border px-4 py-3 text-gray-900 placeholder:text-gray-400" 
                        />
                    </div>
